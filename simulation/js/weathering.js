...
/* Merge into any pre-existing OIL_TYPES (e.g. set by drift.js if its lite
   shim loaded first). The full catalog here always wins because it carries
   the Fingas / Mackay / Delvigne parameters needed by OilBudget. */
globalThis.OIL_TYPES = Object.assign(globalThis.OIL_TYPES || {}, {
  /* Originals from the old drift.js table — keep these keys so old shared
     scenario URLs / presets continue to resolve. */
  light_crude:  { ...globalThis.ADIOS_OILS.arabian_light,  tau_h: 12 },
  medium_crude: { ...globalThis.ADIOS_OILS.arabian_medium, tau_h: 36 },
  heavy_fuel:   { ...globalThis.ADIOS_OILS.hfo380,         tau_h: 200 },
  diesel:       { ...globalThis.ADIOS_OILS.diesel_mgo,     tau_h: 24 },
  condensate:   { ...globalThis.ADIOS_OILS.condensate,     tau_h: 6 },
  /* Expanded catalog — exposes the rest of the ADIOS entries in the UI. */
  arabian_heavy: { ...globalThis.ADIOS_OILS.arabian_heavy,   tau_h: 60 },
  iranian_heavy: { ...globalThis.ADIOS_OILS.iranian_heavy,   tau_h: 48 },
  kuwait_export: { ...globalThis.ADIOS_OILS.kuwait_export,   tau_h: 30 },
  /* Use full ADIOS key `murban_abudhabi`; without this, spreading
     `ADIOS_OILS.murban` (undefined) silently produced an oil with no
     density, no Fingas / Mackay / Delvigne parameters → NaN budget. */
  murban:        { ...globalThis.ADIOS_OILS.murban_abudhabi, tau_h: 18 },
  basrah_light:  { ...globalThis.ADIOS_OILS.basrah_light,    tau_h: 22 },
  ifo180:        { ...globalThis.ADIOS_OILS.ifo180,          tau_h: 150 },
  jet_fuel:      { ...globalThis.ADIOS_OILS.jet_fuel,        tau_h: 8 },
});
...
globalThis.OilBudget = OilBudget;
