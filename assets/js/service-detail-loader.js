            ...
            <div class="sub-services-section" style="margin-top: 4rem; padding-top: 3rem; border-top: 1px solid var(--border);">
                ...
                <div class="product-list-grid">
                    ${service.subServices.map(subItem => {
                        ...
                        return `
                        <a href="service-detail.html?id=${sub.id}" class="product-grid-wrapper" style="text-decoration:none; color:inherit;">
                            <div class="product-card-visual">
                                <img loading="lazy" alt="${sub.name}" class="product-item__image product-image-style" src="${sub.image || service.image}">
                            </div>
